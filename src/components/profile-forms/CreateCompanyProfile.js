...
return (
  <section className='container'>
      ...
      <form className="form" onSubmit={e => onSubmit(e)}>
        ...
        <div className="form-group">
          <textarea placeholder="A short bio of yourself" name="about" value={about} onChange={e => onChange(e)}></textarea>
        ...
        <Link className="btn btn-light my-1" to="/dashboardCompany">Go Back</Link>
      </form>
    </section>
);
